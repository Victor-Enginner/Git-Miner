...
export const allFeaturedRepos: FeaturedRepo[] = [
  ...
  // um mesmo repo pode estar numa categoria temática e em "manual": conta uma vez só
  (r, i, all) => all.findIndex((x) => x.full_name.toLowerCase() === r.full_name.toLowerCase()) === i
);
